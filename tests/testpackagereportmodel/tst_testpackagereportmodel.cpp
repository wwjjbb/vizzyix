...
void testpackagereportmodel::test_data_fetch_data_role_a()
{
    ...
    QCOMPARE(
        something.data(
            something.index(0, PackageReportItem::Column::InstalledVersion),
            Qt::DisplayRole),
        QVariant("(~)4.12.3"));
    QCOMPARE(
        something.data(
            something.index(0, PackageReportItem::Column::AvailableVersion),
            Qt::DisplayRole),
        QVariant("~4.12.3"));
...
void testpackagereportmodel::test_data_fetch_data_role_b()
{
    ...
    QCOMPARE(
        something.data(
            something.index(1, PackageReportItem::Column::InstalledVersion),
            Qt::DisplayRole),
        QVariant("5.15.1-r1"));
    QCOMPARE(
        something.data(
            something.index(1, PackageReportItem::Column::AvailableVersion),
            Qt::DisplayRole),
        QVariant("5.15.1-r1"));
